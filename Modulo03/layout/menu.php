                ...
                <div class="sidebar-menu">
                    ...
                    <ul class="menu ms-3">
                        ...
                        <li class="sidebar-item has-sub">
                            <div class="bd-callout-menu bd-callout-success-menu">
                                <a href="#" class="MenuTopico sidebar-link <?php if($page=='Topico01'){echo 'ativo';}?>"><span id="menuNumero">01 </span>  Gestão Estratégica</a>
                        ...
                        <li class="sidebar-item has-sub">
                            <div class="bd-callout-menu bd-callout-success-menu">
                                <a href="#" class="MenuTopico sidebar-link <?php if($page=='Topico02'){echo 'ativo';}?>"><span id="menuNumero">02 </span>  Diagnóstico Estratégico</a>
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="Topico02.1.php#SubTopico1.1" class="sidebar-sub <?php if($page=='Topico02.1'){echo 'ativo';}?>"><span id="menuNumero">
                                        02.1<span> Tipos de Diagnóstico</span>
                                        </a>
                                    </li>                                      
                                </ul>
                            </div>
                        ...
                        <li class="sidebar-item has-sub">
                            <div class="bd-callout-menu bd-callout-success-menu">
                                <a href="#" class="MenuTopico sidebar-link <?php if($page=='Topico03'){echo 'ativo';}?>"><span id="menuNumero">03 </span>  Formulação Estratégica</a>
